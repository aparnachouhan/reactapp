...
import { DeleteStaff, GetDoctorListAction } from '../../../redux/Clinic/clinicActions';
...
const DoctorList = () => {
  ...
  const staffList = useSelector(state => state.clinic.DoctorList)
